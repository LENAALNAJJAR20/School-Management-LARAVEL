                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            @error('name')
                                            <div
                                                style="color: red; font-weight: bold; font-size: 13px">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="admission_date"
                                                   id="date_of_birth" value="{{old('admission_date')}}"
                                                   placeholder="Enter name">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="marital_status"
                                                   id="admission_date" value="{{old('marital_status')}}"
                                                   placeholder="Enter name">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="permanent_address"
                                                   value="{{old('permanent_address')}}" placeholder="Enter name">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="qualification"
                                               value="{{old('qualification')}}" placeholder="Enter name">
                                        @error('qualification')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="work_experience"
                                           value="{{old('work_experience')}}" placeholder="Enter name">
