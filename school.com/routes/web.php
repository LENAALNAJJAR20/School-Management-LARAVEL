...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::get('admin/student/assign_student_parent/{student_id}/{parent_id}', [ParentController::class, 'AssignStudentParent']);
    Route::get('admin/student/assign_student_parent_delete/{student_id}', [ParentController::class, 'AssignStudentParentDelete']);
    //teacher url
